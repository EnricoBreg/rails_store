class WishlistsController < ApplicationController
  ...
  def update
    if @wishlist.update(wishlist_params)
      redirect_to @wishlist, notice: "Your wishlist was updated successfully."
    else
  ...
  def destroy
    @wishlist.destroy
    redirect_to wishlists_url, status: :see_other, notice: "Your wishlist was deleted successfully."
  end
